...
class LobbyManager
{
    public:
        ...
        LobbyManager(int lobbyCountInput);
        ~LobbyManager();
        ...
        void AddPlayer(int lobbyNum, int sd, string username);
        ...
        void RemovePlayer(int lobbyNum, int sd);
